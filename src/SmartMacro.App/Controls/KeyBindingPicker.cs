...
public sealed class KeyBindingPicker : Button
{
    ...
    private static string CapturePrompt => Strings.Editor_Hotkey_CapturePrompt;
    ...
    private static string EmptyPrompt => Strings.Editor_Hotkey_EmptyPrompt;
    private static string RebindHint => Strings.Editor_Hotkey_RebindHint;

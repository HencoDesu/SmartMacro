...
public sealed class MacroVariableRowViewModel : ObservableObject
{
    ...
    internal MacroVariableRowViewModel(MacroVariableInfo info)
    {
        ...
        {
            VariableKind.Point => Strings_App.Editor_Variables_KindPoint,
            VariableKind.Text => Strings_App.Editor_Variables_KindText,
            _ => Strings_App.Editor_Variables_KindAny,
        };
        WrittenBy = info.SeededByTrigger && info.Writes.Count == 0
            ? Strings_App.Editor_Variables_SeededByTrigger
            : info.Writes.Count == 0
                ? Strings_App.Editor_Variables_Nobody
    ...
    {
        VariableSlot.FoundPointVar => Strings_App.Editor_Variables_SlotFoundPoint,
        VariableSlot.ResultVar => Strings_App.Editor_Variables_SlotResult,
        VariableSlot.PointVar => Strings_App.Editor_Variables_SlotPoint,
        VariableSlot.Tag => Strings_App.Editor_Variables_SlotTag,
        VariableSlot.IconPath => Strings_App.Editor_Variables_SlotIcon,
        _ => string.Empty,
    };
}

...
public sealed class ShellViewModel : ObservableObject, IDisposable
{
        ...
        IMacroLauncher? launcher = null)
    {
        ...
        Modes =
        [
            new ShellModeViewModel(ShellMode.Windows, Strings_App.Shell_Mode_Windows),
            new ShellModeViewModel(ShellMode.Macros, Strings_App.Shell_Mode_Macros),
            new ShellModeViewModel(ShellMode.Runs, Strings_App.Shell_Mode_Runs),
            new ShellModeViewModel(ShellMode.Log, Strings_App.Shell_Mode_Log),
        ];
        ...
        SettingsMode = new ShellModeViewModel(ShellMode.Settings, Strings_App.Shell_Mode_Settings);
    ...
    public string IdleText => Strings_App.Shell_RunBar_Idle;

...
public sealed class NodeChoiceViewModel : ObservableObject
{
    ...
    /// </summary>
    public static NodeChoiceViewModel End { get; } = new(null, Strings_App.Node_Edge_End);
    ...
    /// </summary>
    public static NodeChoiceViewModel Dangling(Guid id) => new(id, Strings_App.Node_Edge_Dangling);

...
public sealed class HotkeyTriggerRowViewModel : TriggerRowViewModel
{
    ...
    public override string TypeLabel => Strings.Node_Type_HotkeyTrigger;
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return Strings.Node_Error_HotkeyUnbound;
        }
    }
...
public sealed class ProcessTriggerRowViewModel : TriggerRowViewModel
{
    ...
    public override string TypeLabel => Strings.Node_Type_ProcessTrigger;
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return Strings.Node_Error_ProcessUnnamed;
        }
    }
}

...
public abstract class ActionNodeRowViewModel : NodeRowViewModel
{
    protected ActionNodeRowViewModel(MacroNode node, TargetSelectorViewModel? target, Guid? next)
        : base(node, target, new NodeEdgeViewModel(Strings_App.Node_Edge_Next, next))
    {
    }
...
public sealed class KeyPressNodeRowViewModel : ActionNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_KeyPress;
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_KeyMissing, DisplayName);
        }
    }
...
public sealed class ClickNodeRowViewModel : ActionNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_Click;
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        if (_useVariable)
        {
            ...
            {
                yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_PointVarMissing, DisplayName);
            }
        ...
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_ClickX, DisplayName, _xText);
        }

        if (NodeInput.ParseInt(_yText) is null)
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_ClickY, DisplayName, _yText);
        }
    }
}
...
public sealed class DelayNodeRowViewModel : ActionNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_Delay;

    public override string Summary =>
        string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Summary_Seconds, _secondsText);
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_Delay, DisplayName, _secondsText);
        }
    }
}
...
public abstract class TagNodeRowViewModel : ActionNodeRowViewModel
{
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_TagMissing, DisplayName);
        }
    }
}
...
public sealed class AddTagNodeRowViewModel : TagNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_AddTag;
...
public sealed class RemoveTagNodeRowViewModel : TagNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_RemoveTag;
...
public sealed class SetIconNodeRowViewModel : ActionNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_SetIcon;
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_IconMissing, DisplayName);
        }
    }
}
...
public sealed class RunSubmacroNodeRowViewModel : ActionNodeRowViewModel
{
    ...
    public override string TypeLabel => Strings_App.Node_Type_RunSubmacro;

    public override string Summary => Join(SubmacroLabel, _await ? Strings_App.Node_Summary_Await : null);
    ...
    public override IEnumerable<string> GetInputErrors()
    {
        ...
        {
            yield return string.Format(CultureInfo.CurrentCulture, Strings_App.Node_Error_SubmacroMissing, DisplayName);
        }
    }
}

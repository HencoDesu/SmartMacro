...
/// которым хранилище объявляет, что библиотека на диске изменилась, — от собственной записи или
/// от наблюдателя за папкой. Отсюда важное свойство: <b>граф и его шаблоны устаревают и
...
public sealed partial class MacroTemplateCache : IDisposable
{
    ...
    private void OnMacrosChanged(IReadOnlyList<MacroGraph> _)
    {

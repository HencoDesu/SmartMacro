...
// вызывающий. За ним стоит MatchTemplateSetNode: ключ победившего шаблона уезжает в переменную
// прогона (а тегом его вешает уже следующая нода — AddTag с подстановкой).
//
// Ключи шаблонов — свободные строки (основы имён файлов набора на диске). Канонический

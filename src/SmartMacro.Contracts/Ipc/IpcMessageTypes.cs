...
public static class IpcMessageTypes
{
    ...
    /// <summary>
    /// Запрос: — → Ответ: <c>TemplateDto[]</c>. Всё дерево <c>templates/</c> в корне установки
    /// (поставляется из <c>Assets/templates/</c> проекта демона, а при публикации поднимается
    /// в корень): одиночные шаблоны из корня дерева, затем содержимое каждой подпапки-набора.
    ///
    ...
    /// права против UIPI, недостающие файлы шаблонов, масштабирование экрана, регистрация
    /// сочетаний, папка на запись, автозапуск.
    ///

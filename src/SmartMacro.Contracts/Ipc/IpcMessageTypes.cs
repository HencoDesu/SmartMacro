...
public static class IpcMessageTypes
{
    ...
    /// <summary>
    /// Запрос: — → Ответ: <c>DiagnosticDto[]</c>. «Проверить сейчас» — пять вопросов к среде:
    /// права против UIPI, недостающие файлы шаблонов, масштабирование экрана, регистрация
    /// аккордов, папка на запись.
    ///
    /// Шестую проверку — время ответа канала — панель делает сама, потому что демон не может

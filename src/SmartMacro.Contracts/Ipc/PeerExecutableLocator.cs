...
public static class PeerExecutableLocator
{
        ...
        string peerProjectFolder)
    {
        ...
        // Раскладка поставки: оба файла в одной папке. Идёт первым и всегда — на машине
        // пользователя второго кандидата просто не будет.
    ...
    /// <summary>
    /// Раскладка разработки: у <c>.../src/SmartMacro.App/bin/Debug/net10.0-windows/</c> есть

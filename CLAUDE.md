...
Gate: `dotnet run --project tests/SmartMacro.Tests` — **927 tests**, and they are expected green before anything is committed.
...
### Cutting a template out of a fresh frame (issue #29)
